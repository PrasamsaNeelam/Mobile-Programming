...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String storeQueryURL= "query";

    // TODO (2) Create a static final key to store the search's raw JSON
    private static final String storeSearch = "results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            String queryUrl = savedInstanceState.getString(storeQueryURL);
            String rawJsonSearchResults = savedInstanceState.getString(storeSearch);
    ...
    public void onSaveInstanceState(Bundle outState, PersistableBundle outPersistentState) {
        ...
        outState.putString(storeQueryURL, queryUrl);
        String rawJsonSearchResults = mSearchResultsTextView.getText().toString();
        outState.putString(storeSearch, rawJsonSearchResults);
    }
}